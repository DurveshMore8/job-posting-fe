...
const AdminSignup: FunctionComponent<AdminSignupProps> = () => {
  ...
  return (
    <main className="dsignup">
      ...
      <section className="dsignup-right">
        <h2 className="dsignup-right-head">Hello Admin!</h2>
        <span className="dsignup-right-desc">
          Welcome to our platform, Admin! Sign up to get started.
        </span>
        <form className="dsignup-right-fields" onSubmit={handleFormSubmit}>
          <div className="dsignup-right-profile">
            {signupData.companyLogo.length == 0 ? (
              <Person />
            ) : (
              <Image
                src={signupData.companyLogo}
                alt=""
                width={100}
                height={100}
