...
interface AdminJobListingProps {}

const AdminJobListing: FunctionComponent<AdminJobListingProps> = () => {
  ...
  return (
    <main className="doctors">
      <section className="doctors-button">
        <Button
          value="Add Job"
          onClick={() => router.push("/admin/job-listing/add")}
        />
      </section>
